...
@section('main-content')
									...
									<div class="row">
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="name" id="name" type="text" placeholder="Enter Votre Nom">
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
	...
	<div class="map-section">
		<div id="myMap">
			<iframe src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=rue%20athene%20+(Kamergi%20audi)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
		</div>
	</div>
	<!--/ End Map Section -->
